...
echo "Execute ckan paster additional."
# echo $PWD
# CWD=$(pwd)
# echo $CWD
# cat ${APP_DIR}/production.ini
# python ${APP_DIR}/src/ckanext/ckanext-openapi/setup.py develop

#python ${APP_DIR}/src/ckanext/ckanext-dcat/setup.py develop


# ckan --config ${APP_DIR}/production.ini views create openapi_view
echo "Ended ckan paster additional."
